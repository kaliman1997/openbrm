...
<%@ page import="com.sapienter.jbilling.server.user.UserDTOEx; com.sapienter.jbilling.server.user.db.CompanyDTO; com.sapienter.jbilling.server.user.permisson.db.RoleDTO; com.sapienter.jbilling.common.Constants; com.sapienter.jbilling.server.util.db.LanguageDTO; com.sapienter.jbilling.common.CommonConstants" %>
								...
								<content tag="label.for">mainSubscription.periodId</content>
					        	 <g:select id="mainSubscription" from="${orderPeriods}"
					                   ...
					                   value="${mainSubscription?.periodId ?: orderPeriods.find {
					  							it?.periodUnit?.id == com.sapienter.jbilling.server.util.Constants.PERIOD_UNIT_MONTH && it?.value == 1}?.id}"/>
					    	</div>
					    </g:applyLayout>
