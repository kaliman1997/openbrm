...
<%@ page import="grails.plugin.springsecurity.SpringSecurityUtils; com.sapienter.jbilling.common.Constants; jbilling.SearchType; com.sapienter.jbilling.server.user.db.CompanyDTO; com.sapienter.jbilling.server.user.db.CompanyDAS" %>
...
<!-- header -->
<div id="header">
    <h1><a href="${resource(dir:'')}">OpenBRM</a></h1>
    <div class="search">
                        ...
                        <div class="top-bg">
                            <div class="btm-bg">
                                ...
                                <sec:access url="/order/list">
								 ...
								 <sec:access url="/device/list">
                                    <div class="input-row">
                                        <g:radio id="devices" name="type" value="DEVICES" checked="${cmd?.type?.toString() == 'DEVICES'}"/>
                                        <label for="devices"><g:message code="search.option.devices"/></label>
                                    </div>
                                </sec:access>
    ...
    <ul class="top-nav">
        ...
        <li>
            <a href="http://www.openbrm.com" class="training">
