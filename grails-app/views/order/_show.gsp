...
<%@page import="org.apache.commons.lang.StringEscapeUtils; com.sapienter.jbilling.server.order.OrderBL; com.sapienter.jbilling.server.order.validator.OrderHierarchyValidator;"%>
...
<div class="column-hold">
    ...
    <g:if test="${!order.deleted}">
        <div class="row">
            ...
            <g:if test="${!(lineTypeIds.get(0)==Constants.ORDER_LINE_TYPE_DISCOUNT)}">
