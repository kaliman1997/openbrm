...
--%>
   ...
   <div class="column-hold" style="width:1050px">
     ...
     <div class="form-edit"  style="width:1050px">
      ...
      &nbsp;
      &nbsp;
     <div class="table-box" style="width:1050px">
   <div class="table-scroll">
    <table id="ratecard" cellspacing="0" cellpadding="0">
         <thead >
	 <tr>
	 <th><g:message code="customer.rate.prefix"/></th>
	 <th><g:message code="customer.rate.rate"/></th>
	 <th><g:message code="customer.rate.validFrom"/></th>
	 <th><g:message code="customer.rate.validTo"/></th>
	 </thead>
	 ...
	 <tbody>
	   ...
	   <div class="btn-box" style="width:1050px">
	   </div>
