...
<content tag="column2">
	...
	<g:else>
        <!-- show empty block -->
        <div class="heading"><strong><em><g:message code="Formulario"/></em></strong></div>
        <div class="box"><div class="sub-box"><em><g:message code="Seleccione la operación a realizar"/></em></div></div>
