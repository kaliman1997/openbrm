...
def appHome = System.getProperty("OPENBRM_HOME") ?: System.getenv("OPENBRM_HOME")


if (appHome) {
    println "Loading configuration files from OPENBRM_HOME = ${appHome}"
    ...
    if (appHome.listFiles({dir, file -> file ==~ /${appName}-.*\.groovy/} as FilenameFilter )) {
        ...
        println "Setting OPENBRM_HOME to ${appHome.canonicalPath}"
        System.setProperty("OPENBRM_HOME", appHome.canonicalPath)
...
log4j = {
    appenders {
        ...
        rollingFile name: 'openbrm',file: 'logs/openbrm.log',layout:pattern(conversionPattern: '%d %-5r %-5p [%c] (%t:%x) %m%n')
		...
		rollingFile name: "stacktrace", maxFileSize: '5MB', maxBackupIndex:2, file: "logs/openbrm-stacktrace.log"
    }
    ...
    debug additivity: false, openbrm: "grails.app.service"
    debug additivity: false, openbrm: "grails.app.controller"

    //Keep this in info to reduce the verbocity of logs
    info additivity: false, openbrm: "grails.app.taglib"

    info additivity: false,  openbrm: "com.sapienter.jbilling.client.authentication.CompanyUserRememberMeFilter"
...
//gdoc aliases
grails.doc.alias.userGuide="1. User Guide"
grails.doc.alias.integrationGuide="2. Integration Guide"
...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
	...
	'/restapi/**': ['IS_AUTHENTICATED_FULLY','API_120'],
...
grails.plugin.springsecurity.basic.realmName = "OpenBRM Web Services"

// authentication filter configuration
grails.plugin.springsecurity.filterChain.chainMap = [
	'/services/**': 'JOINED_FILTERS,-exceptionTranslationFilter',
	'/restapi/**': 'JOINED_FILTERS,-exceptionTranslationFilter, -statelessSecurityContextPersistenceFilter',
