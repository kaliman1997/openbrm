...
target(packageRelease: "Builds the war and packages all the necessary config files and resources in a release zip file.") {
    ...
    zip(filesonly: false, update: false, destfile: packageName) {
        zipfileset(dir: resourcesDir, prefix: "openbrm/resources")
        zipfileset(dir: targetDir, includes: "${grailsAppName}.jar", prefix: "openbrm/resources/api")
        zipfileset(dir: javaDir, includes: "openbrm.properties", fullpath: "openbrm/openbrm.properties")
        zipfileset(dir: configDir, includes: "Config.groovy", fullpath: "openbrm/${grailsAppName}-Config.groovy")
        zipfileset(dir: configDir, includes: "DataSource.groovy", fullpath: "openbrm/${grailsAppName}-DataSource.groovy")
