...
public class SuretaxSuccessfulDeletionTest extends DefaultTest {
	...
	public void testSuccessfulInvoiceDeletion() {
		...
		assertNull("Generated invoice was to be null.", invoice);
