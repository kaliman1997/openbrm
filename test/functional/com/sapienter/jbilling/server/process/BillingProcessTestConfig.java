...
public class BillingProcessTestConfig {
    ...
    public OrderPeriodWS daily () {
        return getOrCreateOrderPeriod(Constants.PERIOD_UNIT_DAY, ApiTestCase.TEST_LANGUAGE_ID, "Daily");
    }

    @Bean
    public OrderPeriodWS weekly () {
        return getOrCreateOrderPeriod(Constants.PERIOD_UNIT_WEEK, ApiTestCase.TEST_LANGUAGE_ID, "Weekly");
    }

    @Bean
    public OrderPeriodWS semiMonthly () {
        return getOrCreateOrderPeriod(Constants.PERIOD_UNIT_SEMI_MONTHLY, ApiTestCase.TEST_LANGUAGE_ID, "Semi-Monthly");
    }

    @Bean
    public OrderPeriodWS monthly () {
        return getOrCreateOrderPeriod(Constants.PERIOD_UNIT_MONTH, ApiTestCase.TEST_LANGUAGE_ID, "Monthly");
    }
