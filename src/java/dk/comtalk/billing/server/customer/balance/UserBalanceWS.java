...
public class UserBalanceWS implements java.io.Serializable {

private static Logger LOG = Logger.getLogger(UserBalanceWS.class);
    ...
    public UserBalanceWS() {
    }
    
    public UserBalanceWS(UserBalanceWS other) {
    	init(other);
    }

    public void init(UserBalanceWS other) {
    	this.id = other.getId();
	...
	public UserBalanceWS(int id, UserDTO baseUserByUserId, CurrencyDTO currencyDTO, OrderLineDTO orderLineDTO, OrderDTO orderDTO, BigDecimal balance, Date createDatetime, Integer deleted) {
        this.id = id;
	...
	public UserBalanceWS(int id, UserDTO baseUserByUserId, CurrencyDTO currencyDTO, OrderLineDTO orderLineDTO, OrderDTO orderDTO, BigDecimal balance, Date activeSince, Date activeUntil, Date createDate, Integer deleted) {
		this.id = id;
        this.baseUserByUserId = baseUserByUserId;
        this.currencyDTO = currencyDTO;
        this.orderLineDTO = orderLineDTO;
