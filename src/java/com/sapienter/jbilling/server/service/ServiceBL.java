...
import com.sapienter.jbilling.server.service.event.NewStatusEvent;
...
//import com.sapienter.jbilling.server.service.db.ServiceFeatureDTO;
//import com.sapienter.jbilling.server.service.db.ServiceFeatureInfoDTO;
    ...
    public Integer create(UserDTO user, OrderDTO order, OrderLineDTO orderLine){
    	...
    	Integer retValue = 0;
    	  ...
    	  try {
    	      ...
    	      serviceDTO.setPassword(user.getPassword());
