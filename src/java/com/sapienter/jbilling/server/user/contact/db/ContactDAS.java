...
public class ContactDAS extends AbstractDAS<ContactDTO> {
	...
	public static final String FIND_PRIMARY_CONTACT_HQL = "SELECT contact "
	...
	public static final String FIND_CONTACT_HQL = "SELECT c "
	...
	public static final String FIND_SIMPLE_CONTACT_HQL = "SELECT c "
			+ "  FROM ContactDTO c, JbillingTable d "
			+ " WHERE c.contactMap.jbillingTable.id = d.id "
			+ "   AND d.name = :tableName "
