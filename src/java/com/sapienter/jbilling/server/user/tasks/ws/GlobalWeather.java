    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.sapienter.jbilling.server.user.tasks.ws.GlobalWeather.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.sapienter.jbilling.server.user.tasks.ws.GlobalWeather.class.getResource(".");
