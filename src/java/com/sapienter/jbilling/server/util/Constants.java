...
public final class Constants implements CommonConstants {
	...
	public static final String TABLE_VOUCHER_STATUS = "voucher_status";
	...
	public static final String TABLE_BUNDLE_STATUS = "bundle_status";
	public static final String TABLE_SCHEDULER_STATUS = "scheduler_status";
	public static final String TABLE_SCHEDULER_TYPE = "scheduler_type";
	...
	// Bundle types
    public static final Integer ONE_TIME = new Integer(1);
    public static final Integer RECURRING = new Integer(2);
    public static final Integer USAGE = new Integer(3);
	 public static final Integer CANCEL = new Integer(4);
   ...
   public static final Integer CHARGE_ONE_TIME = new Integer(1);
   public static final Integer CHARGE_RECURRING = new Integer(2);
   public static final Integer CHARGE_USAGE = new Integer(3);
   
   public static final Integer MATCHING_PRODUCT = new Integer(1);
   public static final Integer NO_MATCHING_PRODUCT = new Integer(1);
	...
	public static final Integer PLUGGABLE_TASK_EXTERNAL_PROVISIONING = new Integer(27);
	...
	public static final int PLUGGABLE_TASK_RATING_PROCESS = 25;
 ...
 //
   ...
   public static final Integer DEVICE_TYPE_SIM = new Integer(1);
   public static final Integer DEVICE_TYPE_NUM = new Integer(2); 

   public static final String TABLE_DEVICE_TYPE= "device_type";
   public static final Integer DEVICE_STATUS_ASSIGNED= new Integer(2);
   public static final Integer DEVICE_STATUS_QUARANTINED= new Integer(3);
   public static final Integer DEVICE_STATUS_RELEASED = new Integer(4);
   public static final Integer USER_DEVICE_STATUS_ACTIVE= new Integer(1);
   public static final Integer USER_DEVICE_STATUS_INACTIVE= new Integer(2);
   public static final Integer USER_DEVICE_STATUS_CANCELLED= new Integer(3);
   
        //Ticket status
   public static final Integer TICKET_STATUS_NEW = new Integer(1);
   public static final Integer TICKET_STATUS_OPENED = new Integer(2);
   public static final Integer TICKET_STATUS_CLOSED = new Integer(3);
	

   public static final Integer DEVICE_STATUS_NEW = new Integer(1);
   
    /*--Service constants--*/
   public static final Integer SERVICE_STATUS_ACTIVE = new Integer(1);
   public static final Integer SERVICE_STATUS_INACTIVE = new Integer(2);
   
    //Notification configuration status
   public final static String CONFIGURATION_ENABLED = "Enable";
   public final static String CONFIGURATION_DISABLED = "Disable";
   public static final String TABLE_NOTIFICATION_TYPE = "notification_type";
}
