...
//    public CardValidationWS validateCreditCard(com.sapienter.jbilling.server.entity.CreditCardDTO creditCard, ContactWS contact, int level);
	...
	public Integer addServiceAlias(Integer serviceId, String aliasName) throws SessionInternalError;
	public Integer addServiceAliasByOrder(Integer orderId, String aliasName) throws SessionInternalError;
	   //public List<MediationErrorWS> getUsageErrors(String fromDate, String toDate, int limit) throws SQLException, NamingException;
	   //public List<AccountBalanceWS> getAccountsBalances();
	   public Integer createSubscription(OrderWS newOrder, OrderChangeWS[] orderChange ,String aliasName);
	   public void createSubscriptionWithAliasList(OrderWS order,OrderChangeWS[] orderChange, List<String> aliasList);
