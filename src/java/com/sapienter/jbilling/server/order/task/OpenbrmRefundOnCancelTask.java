...
public class OpenbrmRefundOnCancelTask extends PluggableTask implements IInternalEventsTask {

    private static final Logger LOG = Logger.getLogger(OpenbrmRefundOnCancelTask.class);
	
	public static final ParameterDescription PARAMETER_REFUND_ITEM = 
    new ParameterDescription("Refund Item", true, ParameterDescription.Type.STR);
    
    
    //initializer for pluggable params
    { 
    	descriptions.add(PARAMETER_REFUND_ITEM);
    }
    ...
    public void process(Event event) {
        ...
        for (String name : parameters.keySet()) {
            ...
            newLine.setDescription(refundItem.getDescription(userBL.getEntity().getLanguageIdField()));
