...
public class SystemProperties {
    ...
    private static final String OPENBRM_HOME = "OPENBRM_HOME";
    private static final String PROPERTIES_FILE = "openbrm.properties";
    ...
    private SystemProperties() throws IOException {
        ...
        LOG.debug("Resolved  resources directory to: %s", resourcesDir);
        System.out.println("Resolved  resources directory to: " + resourcesDir);
    }
     ...
     * can be found.
     *
     * The environment variable OPENBRM_HOME and system property OPENBRM_HOME are examined
    ...
    public static String getJBillingHome() {
        String jbillingHome = System.getProperty(OPENBRM_HOME);

        if (jbillingHome == null) {
            jbillingHome = System.getenv(OPENBRM_HOME);
        }
     ...
     *
     * The resources directory is always assumed to be located in OPENBRM_HOME. If OPENBRM_HOME is not
    ...
    public String get(String key) throws Exception {
        // "base_dir" should always resolve to the OPENBRM_HOME resources dir
