...
public interface CommonConstants {
	...
	public static final Integer VOUCHER_STATUS_EXPORTED = new Integer(2);
	public static final Integer VOUCHER_STATUS_SOLD = new Integer(3);
	public static final Integer VOUCHER_STATUS_REDEEMED = new Integer(4);
	public static final Integer VOUCHER_STATUS_INVALID = new Integer(5);
	...
	public static final Integer BUNDLE_STATUS_INACTIVE = new Integer(1);
	public static final Integer BUNDLE_STATUS_ACTIVE = new Integer(2);
	public static final Integer BUNDLE_STATUS_CANCEL = new Integer(3);
	
	
	
	// SCHEDULER STATUS	
	
	public static final Integer SCHEDULER_STATUS_NEW = new Integer(1);
	public static final Integer SCHEDULER_STATUS_FINISHED = new Integer(2);
	public static final Integer SCHEDULER_STATUS_FAILED = new Integer(3);
	
	//SCHEDULER TYPE
	 public static final Integer SCHEDULER_TYPE_SMS = new Integer(2);
    public static final Integer SCHEDULER_TYPE_EMAIL = new Integer(1);
