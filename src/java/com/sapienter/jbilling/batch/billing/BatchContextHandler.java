...
public class BatchContextHandler {
	...
	private static final FormatLogger logger = new FormatLogger(Logger.getLogger(BatchContextHandler.class));
	...
	private Date getDateFromJbParametersByExecutionId(Integer executionId) {
		return jobExplorer.getJobExecution(executionId.longValue()).getJobParameters().getDate(Constants.BATCH_JOB_PARAM_BILLING_DATE);
	}
}
