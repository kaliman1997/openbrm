...
public class OpenBRM4MediationTask extends PluggableTask implements
        IMediationProcess {

    
    private static final Logger LOG = Logger.getLogger(OpenBRM4MediationTask.class);
    ...
    protected Logger getLog() {
        return Logger.getLogger(OpenBRM4MediationTask.class);
    }
        
    public  OpenBRM4MediationTask() {

      LOG.debug("Initialising Mediation Loader task");
    ...
    public void process(List<Record> records, List<MediationResult> results, String configurationName)
        ...
        LOG.debug("Starting Mediation Loader task");
