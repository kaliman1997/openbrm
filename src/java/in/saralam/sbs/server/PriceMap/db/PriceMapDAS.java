...
public class PriceMapDAS extends AbstractDAS<PriceMapDTO>{

private static final Logger LOG = Logger.getLogger(PriceMapDAS.class);
	...
	public List<PriceMapDTO> findByPrefix(String prefix) {
		Criteria criteria = getSession().createCriteria(PriceMapDTO.class);
	...
	@SuppressWarnings("unchecked")
        public List<PriceMapDTO> getRateByImpCat(String impCat) {
	...
	LOG.debug("In RateDAS values are:"+prefix+","+pdate+","+itemId);
	 ...
	 public List<PriceMapDTO> findByEntity(Integer entityId, Integer limit) {
