...
public class ServiceWS implements Serializable {
    ...
    public ServiceWS(ServiceDTO sub) {

	setId(sub.getId());
        setName(sub.getName());
        setCreateDate(sub.getCreateDate());
        setServiceStatus(sub.getServiceStatus());
        setDeleted(sub.getDeleted());
        setUserId(sub.getBaseUserByUserId().getId());
        setOrderDTO(sub.getOrderDTO());
        setOrderLineDTO(sub.getOrderLineDTO());
	setStatusStr(sub.getStatusStr());
