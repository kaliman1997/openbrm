...
public class RumMapDAS extends AbstractDAS<RumMapDTO>{

private static final Logger LOG = Logger.getLogger(RumMapDAS.class);
	...
	LOG.debug("In RateDAS values are:"+prefix+","+pdate+","+itemId);
	 ...
	 public List<RumMapDTO> findByEntity(Integer entityId, Integer limit) {
	       
	        Criteria criteria = getSession().createCriteria(RumMapDTO.class);
