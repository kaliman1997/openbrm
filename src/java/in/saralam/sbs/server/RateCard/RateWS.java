...
public class RateWS implements Serializable{
	...
	private static final Logger LOG = Logger.getLogger(RateWS.class);

	public RateWS() {
		
	}
	
	public RateWS(Integer id, String prefix, String destination, Integer version, BigDecimal flatRate, BigDecimal conncharge, BigDecimal scaledRate, Integer ratePlan, Date createdDate, Date validFrom, Date validTo, Date lastUpdatedDate,String rateType,CompanyDTO entityId) {
	...
	public RateWS(String prefix, String destination, BigDecimal flatRate, BigDecimal conncharge, BigDecimal scaledRate, Integer ratePlan, Date createdDate, Date validFrom, Date validTo, Date lastUpdatedDate,String rateType,CompanyDTO entityId) {
   ...
   /* public RateWS(Integer id, String prefix, String destination, BigDecimal flatRate) {
    ...
    public RateWS(String prefix, BigDecimal flatRate, Date validFrom, Date validTo) {
