...
public class RateDAS extends AbstractDAS<RateDTO>{

private static final Logger LOG = Logger.getLogger(RateDAS.class);
	...
	public List<RateDTO> findByPrefix(String prefix) {
		Criteria criteria = getSession().createCriteria(RateDTO.class);
	...
	LOG.debug("In RateDAS values are:"+prefix+","+pdate+","+itemId);
	 ...
	 public List<RateDTO> findByEntity(Integer entityId, Integer limit) {
