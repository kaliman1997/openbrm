...
import com.sapienter.jbilling.batch.billing.JobContextHandler;
import com.sapienter.jbilling.common.FormatLogger;
import com.sapienter.jbilling.server.mediation.IMediationSessionBean;
import com.sapienter.jbilling.server.util.Constants;
import com.sapienter.jbilling.server.util.Context;

public class MediationProcessSkipListener extends JobContextHandler implements SkipListener<Object, Object>,InitializingBean{
	
	private static final FormatLogger logger = new FormatLogger(Logger.getLogger(MediationProcessSkipListener.class));
		
	private IMediationSessionBean local;
	...
	public void afterPropertiesSet() throws Exception {
		local = (IMediationSessionBean) Context.getBean(Context.Name.MEDIATION_SESSION);
	}
