...
import com.sapienter.jbilling.batch.billing.BillingProcessFailedTasklet;
...
public class MediationProcessFailedTasklet implements Tasklet {
	
	private static final FormatLogger logger = new FormatLogger(Logger.getLogger(BillingProcessFailedTasklet.class));
	...
	public RepeatStatus execute(StepContribution stepContr, ChunkContext chunkCont)
        ...
        Integer billingProcessId = jobContext.getInt(Constants.JOBCONTEXT_BILLING_PROCESS_ID_KEY);
        Integer usersFailed = jobContext.getInt(Constants.JOBCONTEXT_TOTAL_USERS_FAILED_KEY);
