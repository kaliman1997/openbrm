...
import com.sapienter.jbilling.batch.billing.BillingProcessSucceededTasklet;
...
public class MediationProcessSucceededTasklet implements Tasklet, InitializingBean {
	
	private static final FormatLogger logger = new FormatLogger(Logger.getLogger(BillingProcessSucceededTasklet.class));
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext)
        ...
        if(jobContext.containsKey(Constants.JOBCONTEXT_BILLING_PROCESS_ID_KEY)) {
        	billingProcessId = jobContext.getInt(Constants.JOBCONTEXT_BILLING_PROCESS_ID_KEY);
        }
        if(jobContext.containsKey(Constants.JOBCONTEXT_TOTAL_INVOICES_KEY)) {
        	totalInvoices = jobContext.getInt(Constants.JOBCONTEXT_TOTAL_INVOICES_KEY);
        }
