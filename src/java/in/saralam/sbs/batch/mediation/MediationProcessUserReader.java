...
import com.sapienter.jbilling.batch.ageing.AgeingProcessUserReader;
import com.sapienter.jbilling.common.FormatLogger;
import com.sapienter.jbilling.server.util.Constants;

public class MediationProcessUserReader implements ItemReader<Integer> {
	
	private final FormatLogger logger = new FormatLogger(Logger.getLogger(AgeingProcessUserReader.class));
