...
public class AssetUpdateTask extends PluggableTask implements
	...
	public void process(Event event) throws PluggableTaskException {
		if (event instanceof AssetUpdatedEvent) {
			...
			// asset=AssetDTO{id=300, identifier='22973048972041',
			// assetStatus=205,
			// deleted=0, versionNum=1, createDatetime=2018-07-10 21:24:57.89,
			// notes='',
			// orderLine=200, item=104, isReserved='false'}, assignedTo=130,
			// user=10,
			// oldStatus=AssetStatusDTO{id=206, itemType=405, isDefault=1,
			// isOrderSaved=0,
			// isAvailable=1, isInternal=0, versionNum=0, deleted=0}}

			LOG.debug("ItemCategory "
