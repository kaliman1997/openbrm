...
class FilterFactory {
    ...
    static baseFilters = ([
        ...
        CUSTOMER: [
            ...
            new Filter(type: FilterType.CUSTOMER, constraintType: FilterConstraint.LIKE, field: 'contact.lastName', template: 'value', visible: true),
            ...
            new Filter(type: FilterType.CUSTOMER, constraintType: FilterConstraint.LIKE, field: 'contact.phoneNumber', template: 'value', visible: true),
            ...
            new Filter(type: FilterType.CUSTOMER, constraintType: FilterConstraint.LIKE, field: 'contact.email', template: 'value', visible: true),
        ...
        PARTNER: [
            new Filter(type: FilterType.PARTNER, constraintType: FilterConstraint.LIKE, field: 'contact.firstName', template: 'value', visible: true),
            new Filter(type: FilterType.PARTNER, constraintType: FilterConstraint.LIKE, field: 'contact.lastName', template: 'value', visible: true),
		...
		SERVICE: [
		new Filter(type: FilterType.SERVICE, constraintType: FilterConstraint.EQ, field: 'u.id', template: 'id', visible: true),
	   new Filter(type: FilterType.SERVICE, constraintType: FilterConstraint.LIKE, field: 'userDevice.telephone', template: 'service/telephone', visible: true),
		],
		
		/*VOUCHER FILTERTYPES*/
		VOUCHER: [
			new Filter(type: FilterType.VOUCHER, constraintType: FilterConstraint.STATUS ,field:'status', template:'voucher/status', visible: true),
			new Filter(type: FilterType.VOUCHER, constraintType: FilterConstraint.LIKE, field:'pin',      template:'voucher/pin', visible: true),
			new Filter(type: FilterType.VOUCHER, constraintType: FilterConstraint.LIKE, field:'serialNo', template:'voucher/serialno', visible: true),
			],
